...
def setup_gui():
    # region Dialog
    _tb_base = pygame.image.load(support.resource_path("images/textbox.png")).convert_alpha()
    ...
    entity_focus_indicator = pygame.transform.scale(
        ...
        (entity_focus_indicator.get_width() * 2, entity_focus_indicator.get_height() * 2),
    )
